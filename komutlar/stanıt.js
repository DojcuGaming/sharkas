...
exports.run = async (client, message, args) => {
  ...
  .setTitle('BAŞARILI')
  .setDescription('Sunucu [Burada](https://discord.gg/MXnT6d3) Tanıtıldı! \n\n 12 Saat Sonra Sunucunuzu Tekrardan Tanıtabilirsiniz. \n\n Sunucunu Tanıtabilmek İçin Beni [Ekle!](https://discordapp.com/oauth2/authorize?client_id=739124270940028948&scope=bot&permissions=8)')
  .setColor('GREEN')
 message.channel.send(embed);
    message.channel.createInvite({maxAge: 0}).then((invite) => {
      ...
      .setThumbnail(message.guild.iconURL)
       client.channels.cache.get('739856880041721927').send(embed)
            });
